...
The current baseline is **4097 pass, 0 fail** out of 4097 BCC fixtures — the
BCC pool is fully green. Any refactor — especially pure code moves — must
reproduce this result exactly (all 4097 passing). `verify-all` exits non-zero
...
msc` — currently **3953 pass / 17 fail** out of 3970. (A fixture can be
